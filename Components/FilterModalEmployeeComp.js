...
const FilterModalEmployeeComp = (props) => {
    const statusData = [
        {
            id: 0,
            name: "Upcoming"
        ...
        <View style={styles.modalMainView}>
            <View style={styles.innerView}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={{ maxHeight: height * 0.7, }}>
                    ...
                    <View style={{
                        ...
                        <View style={styles.checkBoxView}>
                            ...
                            />
                            <Text style={styles.saveAsTemplate}>{labels["journal"]}</Text>
                        </View>
                        <View style={styles.checkBoxView}>
                            <BouncyCheckbox
                                size={20}
                                ...
                                unfillColor={Colors.white}
                                iconStyle={{ borderColor: Colors.primary }}
                                isChecked={formFields.deviation}
                                onPress={(value) => {
                                    // handleInputChange( value, personFormKeys.other_name);
                                    setFormFields({
                                        ...formFields,
                                        [formFieldsKeys.deviation]: value,
                                    });
                                }}
                            />
                            <Text style={styles.saveAsTemplate}>{labels["deviation-menu"]}</Text>
                        </View>
                    </View>
                ...
                <CustomButton onPress={() => {
                    ("formFields", JSON.stringify(formFields.patient))
                    props.setParam({
                ...
                }} isLoading={isLoading} title={props?.labels?.applyFilter} style={{ marginTop: 10, minWidth: 290 }} />
...
export default FilterModalEmployeeComp
