...
const ScheduleListing = (props) => {
    ...
    const [param, setParam] = React.useState({ "user_id": "", "shift_id": "", "patient_id": "", "shift_start_date": "", "shift_end_date": "", "shift_date": "", "refreshAPI": false });
    const [dateParam, setDateParam] = React.useState({});
    // const [param, setParam] = React.useState({ "refreshAPI": false });
    ...
    const getScheduleList = async (page, refresh, filterParams) => {
        ...
        let params = {
            ...
            "patient_id": param?.patient.id ?? "",
            "shift_date": param?.shift.id ?? "",
            "shift_end_date": param?.end_date ?? "",
...

                            {
                                selectedTab == list
                                    ...
                                    : selectedTab == week && !isLoading
                                        ...
                                        />
                                        : selectedTab == month
                                            ? <ScheduleMonthView setDateParam={setDateParam} isLoading={isLoading} setIsLoading={setIsLoading} />
                                            : selectedTab == day
                                                ? <ScheduleDayView scheduleList={scheduleList} isLoading={isLoading} setIsLoading={setIsLoading} />
                                                : null
                            }
